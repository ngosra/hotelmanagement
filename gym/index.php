...
<?php
 ...
 if(isset($_POST['submit'])){
 	...
 	$Date=$_POST['date'];
 	$sql="INSERT INTO gym_member(Name,Email,Phone,Reg_date) VALUES('$Name','$Email','$Phone','$Date')";
			...
			<div class="container">		
				<nav class="navbar navbar-default">
					<div class="navbar-header">
						...
						<h1><a  href="index.html">Grilling</a></h1>
					</div>
					<!-- navbar-header -->
			...
			<div class="flexslider">
				<ul class="slides">
					<li>
						...
						<a href="#" class="more" data-toggle="modal" data-target="#myModal">Register As Member</a>  
					</li>
					<li>
						<h3>GRILLING</h3>
						<p>Lorem ipsum dolor sit amet, consectetur adipi est Itaque earum rerum hic tenetur a sapiente delectus reiciendis maiores alias phasellus mattis tellus .</p>
				...
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						<div class="modal-header"> 
							...
							<h4 class="modal-title">Be A Member Today</h4>
						</div> 
							...
							<form action="" method="post">
								...
								<div class="phone_email">
									...
									<div class="form-text">
										...
										<input type="text" name="Phonenum" placeholder="Phone no" required="">
									</div> 
								</div> 
			...
			<div class="w3ls-row">
				<div class="col-md-6 welcome-left">
					<div class="welcome-img">
						<img src="images/gym1.jpg" class="img-responsive zoom-img" alt=""/>
					</div>
					...
					<div class="col-md-6 welcome-left-grids">
						<div class="welcome-img">
							<img src="images/gym3.jpg" class="img-responsive zoom-img" alt=""/>
						</div>
					</div>
					<div class="clearfix"> </div>
				</div>
